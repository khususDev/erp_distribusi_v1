...
const {
    ...
    storeRoute: "/mst_grl_department",
    updateRoute: "/mst_grl_department",
    deleteRoute: "/mst_grl_department",
    deleteMessage: "Hapus department ini?",
});

const { search, entries, filters } = useTable({
    route: "/mst_grl_department",
...
<template>
    <AppLayout>
        ...
        />
        <DataTable
            :headers="['Department', 'Code', 'Description', 'Status', 'Action']"
        ...
        >
            ...
            <TableEmpty
                v-if="!loading && departments.data.length === 0"
                :colspan="6"
            />
