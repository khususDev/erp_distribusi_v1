...
const {
    ...
    storeRoute: "/mst_inv_category",
    updateRoute: "/mst_inv_category",
    deleteRoute: "/mst_inv_category",
    deleteMessage: "Hapus kategori ini?",
});

const { search, entries, filters } = useTable({
    route: "/mst_inv_category",
...
<template>
    <AppLayout>
        ...
        >
            ...
            <TableEmpty
                v-if="!loading && categories.data.length === 0"
                :colspan="6"
            />
