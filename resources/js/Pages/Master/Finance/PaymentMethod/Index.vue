...
const {
    ...
    storeRoute: "/mst_fin_payment_method",
    updateRoute: "/mst_fin_payment_method",
    deleteRoute: "/mst_fin_payment_method",
    deleteMessage: "Hapus payment method ini?",
});

const { search, entries, filters } = useTable({
    route: "/mst_fin_payment_method",
...
<template>
    <AppLayout>
        ...
        >
            ...
            >
                ...
                <td
                    class="border-r border-stroke px-4 py-5 text-center last:border-r-0 dark:border-strokedark"
                >
                    <StatusBadge :active="paymentMethod.is_active" />
                </td>
                ...
                >
                    <TableAction
                        @edit="openEdit(paymentMethod)"
                        @delete="openDelete(paymentMethod.id)"
                    />
                </td>
            </tr>

            <TableEmpty
                v-if="!loading && paymentMethods.data.length === 0"
                :colspan="5"
            />
        ...
        <Modal
            :show="showModal"
            :title="isEdit ? 'Edit Payment Method' : 'Tambah Payment Method'"
            @close="closeModal"
        >
            <!-- ... isi form modal Anda ... -->
