...
const {
    ...
    storeRoute: "/mst_sls_area",
    updateRoute: "/mst_sls_area",
    deleteRoute: "/mst_sls_area",
    deleteMessage: "Hapus area ini?",
});
...
<template>
    <AppLayout>
        <!-- Sesuaikan Halaman -->
        <Breadcrumb pageTitle="Area" :crumbs="['Master Data', 'Sales']" />
        <DataTable
            :headers="['Area Name', 'Code', 'Description', 'Status', 'Action']"
            :from="areas.from"
            :to="areas.to"
            :total="areas.total"
            :search="search"
        ...
        >
            ...
            >
                ...
                >
                    <TableAction
                        @edit="openEdit(area)"
                        @delete="openDelete(area.id)"
                    />
                </td>
            </tr>

            <TableEmpty
                v-if="!loading && areas.data.length === 0"
                :colspan="5"
            />
        ...
        <Modal
            :show="showModal"
            :title="isEdit ? 'Edit Area' : 'Tambah Area'"
            @close="closeModal"
        >
            <!-- ... isi form modal Anda ... -->
